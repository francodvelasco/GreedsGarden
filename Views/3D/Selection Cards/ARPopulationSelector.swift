...
class ARPopulationSelector: ARPresentable {
    static func entity(originPosition: SIMD3<Float>) -> AnchorEntity {
        ...
        baseRectangleEntity.name = "Selector-Home-Base"
        ...
        textEntity.name = "Selector-Home-Title"
        textEntity.setPosition(textPosition, relativeTo: nil)
        
        let sampleAnchor = AnchorEntity(world: anchorPosition)
        do {
            let sampleModel = try ModelEntity.loadModel(named: "House_Poor_Level1", in: nil)
            ...
            sampleEntity?.name = "Selector-Home-Sample"
    ...
    @MainActor static func addToView(arView: ARView, baseAnchor: AnchorEntity, relativePosition: SIMD3<Float>?) {
        ...
        selectorAnchor.name = "Selector-Home"
        
        let buttonWrapper = ARRealityKitSwiftUIView(anchorTitle: "Selector-Home-Background", desiredWidth: 0.15, desiredHeight: 0.105) {
                Text("People")
                    .fontWeight(.medium)
                    .padding(8)
        ...
        baseRectangleEntity.name = "Selector-Home-Background"
        ...
        textEntity.name = "Selector-Home-Text"
        selectorAnchor.addChild(textEntity)*/
        
        guard let pathName = Bundle.main.path(forResource: "House_Poor_Level1", ofType: "usdz"),
        ...
        sampleEntity.name = "Selector-Home-ModelSample"
